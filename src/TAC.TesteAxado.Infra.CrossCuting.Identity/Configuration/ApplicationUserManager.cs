...
namespace TAC.TesteAxado.Infra.CrossCuting.Identity.Configuration
{
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
            ...
            : base(store)
        {
            ...
            /*Código abaixo não funcionar no AZURE - VERIFICAR*/
            //var provider = new DpapiDataProtectionProvider("TAC");
            //var dataProtector = provider.Create("ASP.NET Identity");
            //UserTokenProvider = new DataProtectorTokenProvider<ApplicationUser>(dataProtector);

            var dataProtectionProvider = (IDataProtectionProvider)HttpContext.Current.Cache["DataProtectionProvider"];
